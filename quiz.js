    ...
    let questions = [
    new Question(
    "JavaScript supports ____",
    ["Functions", "XHTML", "HTML", "CSS"],
    "Functions"
    ),
    new Question(
    "CSS stands for ___",
    ...
    new Question(
    "An HTML document can contain ___",
    ["Attributes", "Tags", "Raw text", "All of the above"],
    "All of the above"
    ),
    new Question(
    "A page designed in HTML is called ___",
    ["Application", "Cover page", "Front-end", "Web Page"],
    "Web Page"
    ),
    new Question(
